...
<?php 
include ('../../../model/staff/to_be_block_customer.php');
include ('../../../model/staff/delete_customer.php');
...
<div id="includedContent"></div>
        ...
        <div class="container">
            ...
            <form id="form" class="form" action="block_customer_reason.php" method="POST">
                <div class="form-control">
                    <label for="username">Customer ID</label>
                    <input type="text" value="<?php echo $row1['customerID']; ?>"  name="customerid" readonly/>
