...
include ('../../../model/staff/dashboard.php');
...
<html lang="en">
            ...
            <div class="header-small">
                ...
                <div class="pure-g">
                    ...
                    <div class="box">
                        <div class="column-block">
                            <div class="column-block-header">
                                <h2>Number of Block Users</h2>
                                <span class="column-block-info"><?php  echo $numb10; ?></span>
                            </div>
                    ...
                    <div class="box">
                        <div class="column-block">
                            <div class="column-block-header">
                                <h2>Total Number of active users</h2>
    ...
    <table>
        ...
        <tr>
            <th colspan=6 class="headline"><h2>Staff Information</h2><th>
        </tr>
