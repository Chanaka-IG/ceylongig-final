...
<?php 
include ('../../../model/staff/to_be_block_freelancer_request.php');
include ('../../../model/staff/remove_freelancer_request.php');
...
<div id="includedContent"></div>
        ...
        <div class="container">
            ...
            <form id="form" class="form" action="block_freelancer_request_reason.php" method="POST">
