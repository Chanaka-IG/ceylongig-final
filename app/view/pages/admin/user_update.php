...
<?php 
include ('../../../model/staff/update_user.php');
...
<div id="includedContent"></div>
        ...
        <div class="container">
            ...
            <form id="form" class="form" action="user_update.php" method="POST">
                ...
                <div class="form-control">
                    ...
                    <input type="password"value="<?php echo $row['repassword']; ?>" id="password2" name="repassword" readonly/>
